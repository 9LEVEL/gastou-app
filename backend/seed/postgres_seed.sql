-- CATEGORIAS
INSERT INTO categorias (id, nome, cor, ordem) VALUES
...
-- PRODUTOS
INSERT INTO produtos (id, nome, categoria_id, unidade, unidade_preco, preco_ref) VALUES
...
-- LISTA ABRIL 2026
INSERT INTO listas (id, nome, mes, ano, renda) VALUES (1, 'Abril 2026', 4, 2026, 6000)
ON CONFLICT DO NOTHING;
...
SELECT setval('lista_itens_id_seq', (SELECT MAX(id) FROM lista_itens));

-- COMPRA #1 — Supermercado Local 03/04/2026
INSERT INTO compras (id, lista_id, local, data, total_nfe, observacao) VALUES
...
-- ITENS COMPRA #1
INSERT INTO compra_itens (compra_id, produto_id, nome_nfe, qtd, unidade, preco_unit, preco_total) VALUES
...
SELECT setval('compra_itens_id_seq', (SELECT MAX(id) FROM compra_itens));
